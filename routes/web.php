...
use App\Http\Controllers\admin\adsManagementAdminController;
...
Route::group(['middleware' => ['vendorCheck']], function () {
  ...
  Route::post('/Web/dashBoard/getCityByName', [VendorDashboard::class, 'getCityByName'])->name('web.dashboard.getCityByName'); // web get getCityByName
  ...
  Route::get('/Web/inquery/recieveData', [inqueryController::class, 'recieveData'])->name('web.inqueryAds.recieveData'); // web inquery recieveData
  Route::get('/Web/inqueryAds/{id}/delete', [inqueryController::class, 'delete'])->name('web.inqueryAds.delete'); // web inquery management delete
  Route::get('/Web/inqueryAds/{id}/info', [inqueryController::class, 'info'])->name('web.inqueryAds.info'); // web inquery management info
  ...
  Route::get('Web/Vendor/ActivatePackage/{id}', [ActivatePackagesController::class, 'index'])->name('web.dashboard.activefree'); // web package activate
  Route::get('Web/Vendor/createHashPayhere/{id}', [ActivatePackagesController::class, 'createHashPayhere'])->name('web.dashboard.activatePackage'); // create hash
  Route::get('Web/Vendor/ActivatePackagePayed/{id}', [ActivatePackagesController::class, 'activatePayedPackages'])->name('web.dashboard.activatePackagePayed'); // web package activate payed
  ...
  Route::post('Web/Vendor/changeLocation/Change', [VendorDashboard::class, 'changeLocation'])->name('web.vendorData.changeLocation'); // web location chnage  need to set it in laravel controller
  
  Route::get('Web/Vendor/createHashPayhereTopads/{id}', [ActivatePackagesController::class, 'createHashPayhereTopads'])->name('web.dashboard.createHashPayhereTopads'); // create createHashPayhereTopads
  Route::get('Web/Vendor/ActivateTopAdsPackage/{id}', [ActivatePackagesController::class, 'ActivateTopAdsPackage'])->name('web.dashboard.ActivateTopAdsPackage'); // create ActivateTopAdsPackage
...
//protected routes to web
  ...
  Route::get('/Web/inquery/display/visitors', [inqueryController::class, 'inquery_for_visitors'])->name('web.inquery_for_visitors'); // web new ad display inquery_for_visitors
...
Route::get('/about', [homeController::class, 'about'])->name('web.about'); // web about
Route::get('/contact', [homeController::class, 'contact'])->name('web.contact'); // web contact
Route::get('/refund', [homeController::class, 'refund'])->name('web.refund'); // web refund
...
Route::get('/Vendor/Login/{id?}', [vendorManagement::class, 'index'])->name('web.vendor.login'); // web vendor login index
...
//     $ads = DB::table('ads')->where('ads_customers_id',$item->id)->get();
//     $package_expire = DB::table('assign_packages')->where('customer_id',$item->id)->pluck('package_expire_date')->first();
    
//     if($package_expire){
        
//       foreach($ads as $single){
//      DB::table('ads')->where('id',$single->id)->update([
//          'ad_expire_date' => $package_expire
//          ]);
//     }   
//     }
//   }
...
Route::get("/freePackageSuccessMessage", function () { //return services
   return view('Web.freePackageSuccessMessage');

})->name('web.freePackageSuccessMessage');
...
//new login start
Route::get('/provider', [vendorManagement::class, 'gmailCallBackNew'])->name('login.newGmail'); // new gmail login
Route::get('/callback', [vendorManagement::class, 'handleCallbackGmail'])->name('handleCallbackGmail.newGmail'); // new gmail login
//new login start
// handleCallback
...
Route::group(['middleware' => ['adminCheck']], function () {
  ...
  Route::get('/admin/adsManagement/index', [adsManagementAdminController::class, 'index'])->name('admin.adsManagement.index'); // admin adsManagement view 
  Route::get('/admin/adsManagement/recieveData', [adsManagementAdminController::class, 'recieveData'])->name('admin.adsManagement.recieveData'); // admin adsManagement recieveData 
  Route::get('/admin/adsManagement/{id}/more', [adsManagementAdminController::class, 'more'])->name('admin.adsManagement.more'); // admin adsManagement more
  Route::get('admin/adsManagement/{id}/status', [adsManagementAdminController::class, 'status'])->name('admin.adsManagement.status'); // admin adsManagement status
  Route::post('/admin/adsManagement/updateStatus', [adsManagementAdminController::class, 'updateStatus'])->name('admin.adsManagement.updateStatus'); // admin adsManagement update
    
  Route::get('/admin/dashboard/index', [dashBoardController::class, 'index'])->name('admin.dashboard'); // admin dashboard
  Route::get('/admin/packageRevanue/recieveData', [dashBoardController::class, 'packageRevanueTable'])->name('admin.packageRevanue.recieveData'); // admin dashboard package revanue data
  Route::get('/admin/topup_package/recieveData', [dashBoardController::class, 'packageTopupTable'])->name('admin.topup_package.recieveData'); // admin dashboard topup_package revanue data
  ...
  Route::get('/admin/mainBannerAds/view', [mainBannerController::class, 'index'])->name('admin.mainBannerAds.view'); // main banner management
  Route::post('/admin/mainBannerManagement/create', [mainBannerController::class, 'create'])->name('admin.mainBanner.create'); // main banner create
  Route::get('/admin/mainBannerManagement/recieveData', [mainBannerController::class, 'recieveData'])->name('admin.mainBanner.recieveData'); // main banner recieve data
  Route::get('/admin/mainBannerManagement/{id}/delete', [mainBannerController::class, 'delete'])->name('admin.mainBanner.delete'); // main banner management delete
  ...
  Route::get('/admin/users/status/{id}', [viewUsersController::class, 'status'])->name('admin.users.status'); // admin users getData
  Route::post('/admin/users/update', [viewUsersController::class, 'update'])->name('admin.users.update.status'); // admin update
  Route::post('/admin/users/overideAds', [viewUsersController::class, 'overideAds'])->name('admin.overide.ads'); // admin overide update
  Route::post('/admin/users/overadsTime', [viewUsersController::class, 'overideTime'])->name('admin.adsTime.overide'); // admin adsTime update
  Route::post('/admin/users/overidePackage', [viewUsersController::class, 'overidePackage'])->name('admin.overide.package'); // admin adsTime package
