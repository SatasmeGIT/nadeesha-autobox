        ...
        <nav>
            <ul class="menu-aside">
                ...
                @if(session()->has('admin_data'))
                        ...
                        @else
                 <li class="menu-item{{ request()->routeIs('admin.adminManagement.index') ? ' active' : '' }}">
                    <a class="menu-link" href="{{ route('admin.adminManagement.index') }}">
                 ...
                 <li class="menu-item{{ request()->routeIs('admin.dashboard') ? ' active' : '' }}">
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        <i style="margin-right: 10px !important; color: #2AAA8A !important;"
                            class="fa-solid fa-chart-line  fa-lg"></i>
                ...
                <li class="menu-item{{ request()->routeIs('admin.users.view') ? ' active' : '' }}">
                  ...
                  <li class="menu-item{{ request()->routeIs('admin.adsManagement.index') ? ' active' : '' }}">
                    <a class="menu-link" href="{{ route('admin.adsManagement.index') }}">
                        <i  style="margin-right: 12px !important; color: #2AAA8A !important;" class="fa-solid fa-upload"></i>
                        <span class="text">Ads Management</span>
                    </a>
                </li>
                ...
                <li class="menu-item{{ request()->routeIs('admin.addCategory.view') ? ' active' : '' }}">
                    <a class="menu-link" href="{{ route('admin.addCategory.view') }}">
                        <i style="margin-right: 10px !important; color: #2AAA8A !important;"
                            class="fa-solid fa-list-check fa-lg"></i>
                ...
                <li class="menu-item{{ request()->routeIs('admin.top_ad_management.view') ? ' active' : '' }}">
                    <a class="menu-link" href="{{ route('admin.top_ad_management.view') }}">
                        <i style="margin-right: 10px !important; color: #2AAA8A !important;"
                            class="fa-solid fa-medal  fa-lg"></i>
                ...
                <li class="menu-item{{ request()->routeIs('admin.sliderManagement.view') ? ' active' : '' }}">
                    <a class="menu-link" href="{{ route('admin.sliderManagement.view') }}">
                        <i style="margin-right: 10px !important; color: #2AAA8A !important;" class="fa-solid fa-image "></i>
                        <span class="text">Slider Management</span>
                    </a>
                </li>
                
                 <li class="menu-item{{ request()->routeIs('admin.mainBannerAds.view') ? ' active' : '' }}">
                    <a class="menu-link" href="{{ route('admin.mainBannerAds.view') }}">
                        <i style="margin-right: 10px !important; color: #2AAA8A !important;" class="fa-solid fa-image "></i>
