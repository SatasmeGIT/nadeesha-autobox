...
@section('section')
    ...
    <section class="content-main">
        <div class="content-header">
            <div>
                <h2 class="content-title card-title">Make</h2>
                <p>You can manage maker here</p>
            </div>
            <div>
            ...
            <div class="card mb-4 col-3">
                ...
                <div class="card-body">
                    <form id="create_brand_record">
                        ...
                        <div class="mb-4">
                            <label for="brand_name" class="form-label">Maker Name</label>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Maker Details</h5>
