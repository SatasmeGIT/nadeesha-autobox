...
@section('content')
    <style>
        ...
        #garage_more_modal .modal-content {
            max-width: 80% !important; /* Adjust the percentage as needed */
            margin: 0 auto !important;; /* Center the content horizontally */
        }
        .modal-body {
            max-height: 80vh !important; /* Adjust the percentage as needed */
            overflow-y: auto !important;
        }
        .form-group input,textarea,select{
            border: 2px solid #ad9c9c !important;
        }
        ...
        <div class="page-content pt-50 pb-50">
            <div class="container">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-5 card p-2 col-sm-12">
                                <div class="m-1 p-2">
                                    <form id="garageForm">
                            ...
                            <div class="col-md-7 col-12">
                                    ...
                                    <div>
                                        <table id="display_garage_details" >
                                            <thead>
                                                <tr>
                                                    <th  class="align-middle" scope="col">ID</th>
                                                    <td  class="align-middle" scope="col">Name</td>
                                                    <td  class="align-middle" scope="col">Status</td>
                                                    <td  class="align-middle" scope="col">Action</td>
                                                </tr>
                                            </thead>
                                            <tbody>
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       ...
                       <a class="mb-2" target="_blank" id="url_more_details" href="#" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: inline-block; max-width: 100%;">
                            <p style="color: rgb(8, 167, 88); text-decoration: underline;" id="url_more_details_text">Your long URL text goes here</p>
                        </a>
