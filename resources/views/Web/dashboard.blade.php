...
@section('content')
    ...
    <!--End header-->
    <main class="main pages remove_white_background">
                                    ...
                                    <ul class="nav flex-column" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="dashboard-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false"><i style="margin-right:4px !important;" class="fi-rs-settings-sliders "></i>Dashboard
                                            </a>
                                        </li>
                                        ...
                                        @else
                                            <li class="nav-item">
                                                <a class="nav-link " id="account-detail-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-selected="true"><i style="margin-right:4px !important;" class="fi-rs-user"></i>Update account</a>
                                            </li>
                                        @endif
                                        <li class="nav-item ">
                                            <a class="nav-link  " id="orders-tab" data-bs-toggle="tab" href="#myPackages"
                                                role="tab" aria-controls="orders" aria-selected="false"><i style="margin-right:4px !important;"
                                                    class="fi-rs-shopping-bag "></i>Package Details</a>
                                        </li>

                                       
                                            <li class="nav-item ">
                                                <a class="nav-link  " href="{{ route('web.inqueryAds') }}"><i style="margin-right:4px !important;"
                                                        class="fi-rs-shopping-bag "></i>Inquery Ads</a>
                                            </li>
                                      

                                        <li class="nav-item">
                                            <a class="nav-link" id="track-orders-tab"
                                                href="{{ route('vendor.dashboard.adsmanagement') }}"><i style="margin-right:4px !important;"
                                                    class="fi-rs-shopping-cart-check "></i>Ads
                                                Management</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="track-orders-tab"
                                                href="{{ route('web.dashboard.index') }}"><i class="fa fa-car" style="margin-right:4px !important;"
                                                    aria-hidden="true"></i> Garage Management</a>
                                        </li>
                                       
                                           <li class="nav-item">
                                            <a class="nav-link" id="track-orders-tab"
                                                href="{{ route('web.ads_inquery') }}"><i style="margin-right:4px !important;" class="fa-solid fa-shop "></i>My Inqueries</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link"  href="{{ route('web.vendor.logout') }}"><i style="margin-right:4px !important;"
                                                    class="fi-rs-sign-out "></i>Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body row">
                                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                                    <div style="border:  @if($package_expired_check) rgba(202, 4, 37, 1)  @else 1px  rgba(219, 215, 215, 0.685)  @endif solid ; border-radius:5px ;"
                                                        class="p-1">
                                                        <div
                                                            style="display: flex; justify-content: space-between; align-items: center;">
                                                            <h5 class="text-left m-2">Ad Package</h5>
                                                            <a class="btn btn_success" href="{{ route('web.dashboard.adsPackages') }}"
                                                        ...
                                                        @if ($current_package_details)
                                                            <table style="margin: 4px;" class="table table-striped">
                                                                <tbody>
                                                                    ...
                                                                    @if($package_expired_check)
                                                                    <tr  class="p-2 m-1">
                                                                    <td colspan="2"  style="color:red !important;">Package expired , When you purchase a new package, existing ads will be added.</td>
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                                    <div style="border: 1px solid rgba(219, 215, 215, 0.685); border-radius:5px ;"
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="btn btn_success" href="{{ route('web.dashboard.topAdsPackages') }}"
                                                                style="margin-right: 20px;">Buy Package</a>
                                                        </div>

                                                        <div class="text-center m-2 p-2">
                                                            You can add bulk of top ads to your current package
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 col-lg-6">
                                                            <select name="city" style="height: 60px;"
                                                                class="form-select" id="city_append_html"
                                                                aria-label="Default select example">
                                                                <option value="">
        ...
        <div class="modal fade" id="edit_vendor_details_single" tabindex="-1" aria-labelledby="exampleModalLabel"
          ...
          <!-- Modal -->
        <div class="modal fade" id="edit_location" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" >Change District</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="row shipping_calculator">
                        <div class="form-group col-lg-6">
                            <div class="custom_select">
                               <select name="district" id="district_select" class="form-control select-active custom-width"
                            ...
                            <span id="district_error" class="clear_form_error text-danger"></span>
                              
                            </div>
                        </div>
                        <div class="form-group col-lg-6">
                            <div class="custom_select">
                                <select name="city" id="city_data" class="form-control select-active custom-width"
                                    style="width: 100% !important; max-width: 100% !important;">
                                    <option  value="">Choose City ...</option>
                                </select>
                                  <span id="city_error" class="clear_form_error text-danger"></span>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" id="edit_district_data_btn" class="btn btn-primary">Save changes</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajaxSetup({
                ...
                $('#district_select').change(function() { //get city values
                ...
                var selected_value = $(this).val();
                  ...
                  $.ajax({
                    type: 'POST',
                    url: "{{ route('web.dashboard.getCityByName') }}",
                    data: {
                        value: selected_value,
                    },
                    success: function(data) {
                        ...
                        $("#city_append_html").html(city_append);
                    }
                });
            ...
            $('#edit_district_data_btn').click(function(){
                
                document.getElementById("edit_district_data_btn").disabled = true;
                $('.clear_form_error').html('');
                ...
                // ajax post start 
                $.ajax({
                    url: "{{ route('web.vendorData.changeLocation') }}",
                    method: "POST",
                    processData: false,
                    contentType: false,
                    data: form_data,
                    ...
                    document.getElementById("edit_district_data_btn").disabled = false;
                    ...
                    error: function(error) {
                        document.getElementById("edit_district_data_btn").disabled = false;
                        $('#district_error').html(error.responseJSON.errors
                            .district);
