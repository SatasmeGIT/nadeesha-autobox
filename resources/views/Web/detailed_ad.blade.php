...
@section('content')
    <style>
        ...
        @media screen and (max-width: 768px) {
            .current-price , .title-detail ,.font_size_change {
                font-size: 18px !important; /* Decreased font size for mobile screens 
            }
        }
    </style>
    <main class="main">
                        ...
                        <div class="row mb-50 mt-30">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <div class="row font_size_change">
                                        <div class="col-sm-12  col-md-6 col-lg-6">
                                            <div class="font-xs">
                                                <ul class="mr-50 float-start">
                                                    <li class="mb-5 font_size_change">Type: <span
                                                            class="text-brand font_size_change">{{ $detailed_ads[0]->vt_name }}</span></li>
                                                    <li class="mb-5 font_size_change">Manufacturer:<span class="text-brand font_size_change">
                                                            {{ $detailed_ads[0]->brand_name }}</span></li>
                                                    <li class="mb-5 font_size_change">Model: <span
                                                            class="text-brand font_size_change">{{ $detailed_ads[0]->model_name }}</span>
                                                    </li>
                                                    <li class="mb-5 font_size_change">District: <span
                                                            class="text-brand font_size_change">{{ $detailed_ads[0]->district }}</span>
                                                    </li>
                                                    <li class="font_size_change" style="margin-bottom: 20px !important;">City: <span
                                                            class="text-brand font_size_change">{{ $detailed_ads[0]->city }}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-sm-12  col-md-6 col-lg-6">
                                            <div class="font-xs">
                                                <ul class="mr-50 float-start">
                                                    <li class="mb-5 font_size_change">Seller: <span
                                                            class="text-brand font_size_change">{{ $detailed_ads[0]->First_Name }}
                                                            {{ $detailed_ads[0]->Last_Name }} </span></li>
                                                    <li class="mb-5 font_size_change">Email:<span class="text-brand font_size_change">
                                                            {{ $detailed_ads[0]->email }}</span></li>
                                                    <li class="mb-5 font_size_change">Phone: <span
                                                            class="text-brand font_size_change">{{ '+94' . $detailed_ads[0]->contact }}</span>
                                                    </li>
                                                   <li class="mb-5 font_size_change">Optional Phone: 
                                                        <?php 
                                                            $optionalPhone = $detailed_ads[0]->contact_optional;
                                                    
                                                            if ($optionalPhone) {
                                                                echo '<span class="text-brand">+94' . $optionalPhone . '</span>';
                                                            } else {
                                                                echo 'Not found';
                                                            }
                                                        ?>
                                                     ...
                                                     <li class="mb-5 font_size_change">Condition: <span
                                                            class="text-brand font_size_change">{{ $detailed_ads[0]->ads_condition }}</span>
                                                    </li>
