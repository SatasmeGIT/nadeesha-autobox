                            ...
                            @foreach ($filterd_ads as $item)
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div style="margin: 13px;" class="product-card"
                                        ...
                                        <div style="  @if ($item->is_top_id == 1) border:#37B093 2px solid !important; @endif  background-color:#00A791 !important; height:300px !important;"
                                            class="product-info ">
                                            <p style="color: #fff !important;" class="category">{{ $item->vt_name }}</p>
                                            <p style="color: #fff !important;" class="category">Ad number :
                                                {{ $item->ad_number }}</p>
                                            <h5 style="color: #fff !important;" class="title">   {{ Illuminate\Support\Str::limit($item->ad_title, 50) }}</h5>
                                            <hr
                                                style="margin: 0 auto; color: #d9e0d9 !important; width: 100% !important; height: 4px !important;">
                                            <h4 style="color: #fff !important;" class="price">
