            ...
            <div class="row flex-row-reverse">
                        ...
                        @else
                            @foreach ($inquery_ads as $item)
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div style="margin: 13px;" class="product-card p-3"
                                        ...
                                        <div class="product-info p-2" style="background-color: #00A791 !important;">
                ...
                <div class="card w-50 mx-auto m-4">
                  <div class="card-body text-center">
                    To view auto parts inquiry ads you must purchase our ad package.
                  </div>
                </div>
                @endif
