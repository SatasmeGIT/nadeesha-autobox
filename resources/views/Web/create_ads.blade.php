        ...
        <div class="page-content pt-50 pb-50">
            <div class="container">
                <div class="card">
                    ...
                    @if($ad_data)  
                    <div class="card-header">
                        <p>Avilable ad count : <span>{{ $ad_data->available_ad_count }}</span></p>
                        <p>Avilable topad count : <span>{{ $ad_data->available_top_count }}</span></p>
                        <p>Package expire date : <span>{{ \Carbon\Carbon::parse($ad_data->package_expire_date)->diffForHumans() }}
                      </span></p>
                    </div>
                    @endif
                        ...
                        <div class="row">
                            ...
                            @else
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="input-group">
                                            <div  class="input-group-prepend">
                                                <span style="height:100% !important;" class="input-group-text" id="basic-addon1">+94</span>
                                            </div>
                                            <input type="number" value="{{ session('vendor_data')->phone }}" class="form-control" placeholder="Enter Phone Number" name="phone" aria-describedby="basic-addon1">
                                           
                                        </div>
                                         <span class="clear_form_error" id="phone_error"></span>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span style="height:100% !important;" class="input-group-text" id="basic-addon2">+94</span>
                                            </div>
                                            <input type="number" class="form-control"  placeholder="Enter Secondary Number(Optional)" name="secondary" aria-describedby="basic-addon2">
                                         
                                        </div>
                                           <span class="clear_form_error" id="secondary_error"></span>
                                    </div>
                                </div>
                                ...
                                <div class="row shipping_calculator">
                                    <div class="form-group col-lg-6">
                                        <div class="custom_select">
                                            <select style="border: 1px solid #EAF1D8 !important;" id="vehicle_type" name="vehicle_type"
                                ...
                                <div class="row shipping_calculator">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="custom_select">
                                            <select id="condition_" name="condition" style="height: 62px !important; background-color:white !important;"
                                                class="form-control ">
                                ...
                                <div class="form-group row ">
                                    ...
                                    @if ($package_max_image >= 4)
                                        <div  class=" col-md-4 col-sm-12">
                                            <div class="m-1">
                                                <input  id="image_4" data-allowed-file-extensions="jpeg  jpg png"
                                    ...
                                    @if ($package_max_image >= 5)
                                        <div  class=" col-md-4 col-sm-12">
                                            <div class="m-1">
                                                <input  id="image_5" data-allowed-file-extensions="jpeg  jpg png"
                                    ...
                                    @if ($package_max_image >= 6)
                                        <div  class=" col-md-4 col-sm-12">
                                            <div class="m-1">
                                                <input  id="image_6" data-allowed-file-extensions="jpeg jpg png"
                                ...
                                <div class="chek-form">
                                    <div class="custome-checkbox">
                                        ...
                                        <label style="color:#00A36C !important;" class="form-check-label" for="exampleCheckbox1"><i
                                                class="fa-solid fa-tag m-1"></i><span style="color:white !important;"> negotiable</span></label>
                                    </div>
                                </div>
                                <div class="chek-form">
                                    <div class="custome-checkbox">
                                        <input class="form-check-input" type="checkbox" name="topad"
                                            id="exampleCheckbox2" value="topad" />
                                        <label for="exampleCheckbox2" style="color:#00A36C !important;" class="form-check-label" ><i
                                                class="fa-solid fa-anchor m-1"></i><span style="color:white !important;">Publish as a top
                                                ad</span></label>
                                    </div>
                                </div>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    error: function(error) {
                        ...
                        $('#phone_error').html(error.responseJSON.errors
                            .phone);
                        $('#secondary_error').html(error.responseJSON.errors
                            .secondary);
            ...
            $('#change_location').click(function() {
                ...
                if (!city || !specialValue) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'District and City are required!',
                    });
            ...
            $('#district_value').change(function() { //get city values
              ...
              $('#vehicle_type').change(function() {
                  var model_append = '';
                // Add a manual record with null value and "Please select" text
                model_append += '<option value="" selected >Please select</option>';
                ...
                models.disabled = false;
                        ...
                        var brands_append = '';
                        // Add a manual record with null value and "Please select" text
                        brands_append += '<option value="" selected >Please select</option>';
                        $.each(data, function(index, row) {
                ...
                brands.disabled = false;
                models.disabled = false;
                        // Close SweetAlert2 in case of an error
                        // Swal.close();
                    }
                });
            });
