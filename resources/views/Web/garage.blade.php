                                        ...
                                        <div class="vendor-info d-flex justify-content-between align-items-end mt-30">
                                            <ul class="contact-infor text-muted">
                                                <li><strong>Address: </strong>
                                                    <span> 
                                                            <span>{{ Illuminate\Support\Str::limit($item->address, 50) }}</span>
                                                    </span>
                                                </li>
                                                <li><strong>Call
                                                ...
                                                <li> <i class="fa-solid fa-city" style="color: #5edba1;"></i> <strong>Maps
                                                        :</strong> <a target="_blank" href="{{ $item->url }}"> <span>{{ $item->city }}</span> </a> </li>
