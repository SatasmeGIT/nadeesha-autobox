                        ...
                        <div class="col-lg-4  col-md-6 col-sm-12 ">
                            ...
                            <div style="margin-bottom: 20px !important;">
                                <div class="card-login ">
                                    ...
                                    <!--</a>-->
                                    <a href="{{ route('login.newGmail') }}" class="social-login google-login">
                                ...
                                <div class="padding_eight_all bg-white">
                                    <div class="heading_s1">
                                        ...
                                        <h5 class="mb-30">Don't have an account? <a
                                                href="{{ route('web.vendor.register') }}">Create here</a></h5>
                                    </div>
                                    <form id="login_form">
                                        <input type="hidden" name="origin" value="{{ $id ?? 'original' }}">
            ...
            $('#login_btn').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        else if (response.code == 'loged_but_no_package') {
                            window.location.href = "{{ route('web.inquery_for_visitors') }}";
                        }
                        else if(response.code == 'buyPackage'){
                             window.location.href = "{{ route('web.dashboard.adsPackages') }}";
                        }
                         else if(response.code == 'my_inquiry'){
                             window.location.href = "{{ route('web.ads_inquery') }}";
                        }
