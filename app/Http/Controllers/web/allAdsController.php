...
class allAdsController extends Controller
{
    public function view()
    {
        ...
        $filterd_ads = DB::table('ads')
            ...
            ->select('ads_images.name', 'ads.ad_title', 'ads.ad_price', 'ads.ad_title', 'ads.id', 'vehicle_types.vt_name', 'ads.created_at', 'ads.ad_number', 'ads.ad_city', 'ads.ad_district', 'ads.ad_view_count','ads.is_top_id')
            ->paginate(12);
