...
{    
     public function changeLocation(Request $request){
       ...
       $district = DB::table('districts')->find($request->district);   // not work
       
       $result = DB::table('users')->where('id',session('vendor_data')->id)->update([
     ...
     public function index()
     {
        ...
        ->first();
          ...
          return view('Web.dashboard', compact('district', 'vendor_details', 'current_package_details', 'dealer', 'vendor_has_premium','package_expired_check'));
     }
     ...
     {
          $district_id = DB::table('districts')->where('name_en', $request->value)->first();
      
          $data = DB::table('cities')->where('district_id', $district_id->id)->get('name_en');
          return $data;
     }
